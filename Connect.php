...
$sql = "SELECT Email,Phone,Admin from users where Email='$Email' AND pass_word='$pass'"; //searching for what username and password vaild
...
if ($result->num_rows > 0) { //if result bigger than 0 thats mean password and username is vaild
  ...
  $_SESSION["Phone"] = $row["Phone"]; //start session of lastname to print it!
